...
select item_purchased as product ,round(avg(review_rating::numeric),2) as Average_product_rating from customer  group by item_purchased order by Average_product_rating desc limit 5;
